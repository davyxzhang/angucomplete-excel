    ...
    function angucomplete ($parse, $http, $sce, $timeout) {
        ...
        return {
            ...
            template: '<div class="angucomplete-holder">'
                        +'<textarea id="autoComplete_value" ng-model="searchStr" placeholder="{{placeholder}}"'
                        +'class="form-group form-control angucomplete-no-resize" ng-focus="resetHideResults()" ng-blur="hideResults()"'
                        +'ng-click="checkCaretPosition()"/>'
                        +'<div id="autoComplete_dropdown" class="angucomplete-dropdown" ng-if="showDropdown">'
                        ...
                        +'</div>'
                        +'<div class="angucomplete-row" ng-repeat="result in results" ng-mousedown="selectResult(result)" ng-mouseover="hoverRow($index)" ng-class="{\'angucomplete-selected-row\': $index == currentIndex}">'
                        ...
                        +'</div>'
                        +'<div class="angucomplete-title" ng-if="!matchClass">{{result.originalObject.abb}}'
                        +'</div>'
                        +'<div ng-if="result.description && result.description !== \'\'" class="angucomplete-description">{{result.description}}'
                        +'</div>'
                        +'</div>'
                        +'</div>'
                        +'</div>'
